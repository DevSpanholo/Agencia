      ...
      <Container className="relative z-10">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-4xl lg:pr-24">
          <h2 className="font-display text-4xl font-medium tracking-tighter text-blue-600 sm:text-5xl">
            Quem deve nos escolher?
          </h2>
          <p className="mt-4 font-display text-2xl tracking-tight text-blue-900">
            Médicos ou clínicas que buscam crescer e se destacar no mercado. Vamos desenvolver uma estratégia personalizada para o seu objetivo. Garantimos que você será visto e que conquistará novos clientes.
            Agende agora uma reunião presencial ou online.
          </p>
        </div>
      </Container>
